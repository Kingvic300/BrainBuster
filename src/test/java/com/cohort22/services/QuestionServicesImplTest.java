...
public class QuestionServicesImplTest {
    ...
    public void setUp() {
        ...
        sampleQuestion.setText("Why is akerele short");
    ...
    public void testThatGetQuestionByIdWorks() {
        ...
        assertEquals("Why is akerele short", foundQuestion.getText());
    }
